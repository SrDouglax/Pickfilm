...
export default function Home() {
  ...
  return (
    <main className={`w-full h-full ease-in-out duration-500 ${hide ? "opacity-0 scale-110" : "opacity-100 scale-100"}`}>
      <section className="w-full h-full flex flex-col gap-6 justify-center">
        <div className="gap-2 px-8 z-10 w-full flex flex-col items-center justify-center">
          <Image
            ...
            quality={100}
            alt={"Icone Filmeeter"}
            className="aspect-auto p-1 mb-4 w-min max-w-[75%] object-contain animate-[animate-in_1000ms_ease-in-out]"
            width={386.5}
            height={322.25}
          />
          <h2
        ...
        <div className="relative w-full flex items-center justify-center mt-4">
          <div className="absolute w-full h-full z-60 overflow-hidden flex flex-col items-center justify-center group blur-[2px]">
            ...
            <div className="relative w-[200%] h-[1px] animate-[line-animate_3100ms_ease-in-out_infinite] group-hover:animate-[line-animate_720ms_ease-in-out_infinite] flex-shrink-0 bg-gradient-to-r from-transparent to-transparent line-animate via-fuchsia-600 left-1/2"></div>
            <div className="relative w-[200%] h-[1px] animate-[line-animate_8500ms_ease-in-out_infinite] group-hover:animate-[line-animate_1220ms_ease-in-out_infinite] flex-shrink-0 bg-gradient-to-r from-transparent to-transparent line-animate via-fuchsia-600 left-1/2"></div>
            ...
            <div className="relative w-[200%] h-[1px] animate-[line-animate_5600ms_ease-in-out_infinite] group-hover:animate-[line-animate_2920ms_ease-in-out_infinite] flex-shrink-0 bg-gradient-to-r from-transparent to-transparent line-animate via-fuchsia-600 left-1/2"></div>
            <div className="relative w-[200%] h-[1px] animate-[line-animate_5500ms_ease-in-out_infinite] group-hover:animate-[line-animate_1320ms_ease-in-out_infinite] flex-shrink-0 bg-gradient-to-r from-transparent to-transparent line-animate via-fuchsia-600 left-1/2"></div>
            ...
            <div className="relative w-[200%] h-[1px] animate-[line-animate_8000ms_ease-in-out_infinite] group-hover:animate-[line-animate_1920ms_ease-in-out_infinite] flex-shrink-0 bg-gradient-to-r from-transparent to-transparent line-animate via-fuchsia-600 left-1/2"></div>
            ...
            <div className="relative w-[200%] h-[1px] animate-[line-animate_6500ms_ease-in-out_infinite] group-hover:animate-[line-animate_4020ms_ease-in-out_infinite] flex-shrink-0 bg-gradient-to-r from-transparent to-transparent line-animate via-fuchsia-600 left-1/2"></div>

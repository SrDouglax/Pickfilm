...
export default function AllGenres({
  ...
  return (
    <div
      className={`${
        selectedGenre === undefined && !showFilterOptions
      ...
      <div className="flex flex-col max-w-4xl w-full h-full px-4 py-4 overflow-y-auto scroll-zero gap-3">
        <h2
          className={`ease-in-out text-2xl mb-2 font-bold text-white duration-200`}
